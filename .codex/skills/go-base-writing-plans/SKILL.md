---
name: go-base-writing-plans
description: Create a detailed implementation plan for this go-base repository from a spec or requirements before touching code.
---
