---
name: go-base-sql-upgrade-guardrails
description: Guardrails for writing or modifying incremental SQL upgrade scripts under server/sql/ in this go-base repository. Use before creating or editing any persisted-state migration SQL.
---
