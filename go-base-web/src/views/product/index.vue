    ...
    >
      ...
      <template #toolbar>
        <a-space>
          ...
          <a-button @click="handleExport" v-permission="'product:export'"><DownloadOutlined /> 导出</a-button>
          <a-upload
          ...
          <a-button @click="handleDownloadTemplate" v-permission="'product:import'"><FileExcelOutlined /> 下载模板</a-button>
...
import { PlusOutlined, DeleteOutlined, ExclamationCircleOutlined, FolderOutlined, AppstoreOutlined, TagOutlined, BarChartOutlined, DownloadOutlined, UploadOutlined, FileExcelOutlined } from '@ant-design/icons-vue'
import ProTable from '@/components/ProTable.vue'
import ProductForm from './components/ProductForm.vue'
import ProductStats from './components/ProductStats.vue'
import { getProductList, deleteProduct, batchDeleteProduct, exportProduct, importProduct, downloadTemplateProduct } from '@/api/product'
...
const handleExport = async () => {
  try {
    ...
    link.href = url
    link.download = `product_${new Date().getTime()}.xlsx`
    link.click()
