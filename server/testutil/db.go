...
func SetupFileServiceTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&model.SysConfig{}, &model.AIProviderConfig{}, &model.SysFile{}, &model.SysFileReference{}, &model.SysUser{}, &model.SysFileChunk{}, &model.AIMessage{}); err != nil {
