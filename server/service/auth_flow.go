...
type AuthFlowService struct {
	...
	GetUserInfoFromCache  func(userID uint) (*UserInfoCache, error)
	...
	SetUserInfoToCache    func(userID uint, cache *UserInfoCache) error
...
func NewAuthFlowService() *AuthFlowService {
	return &AuthFlowService{
		CheckLoginLock:        Captcha.CheckLoginLock,
		IsLoginCaptchaEnabled: Captcha.IsLoginCaptchaEnabled,
		GetCaptchaType:        Captcha.GetCaptchaType,
		VerifyCaptcha:         Captcha.VerifyCaptcha,
		GetClientInfo:         utils.GetClientInfo,
		LoginUser:             User.Login,
		IncrLoginRetry:        Captcha.IncrLoginRetry,
		GetLoginMaxRetry:      Captcha.GetLoginMaxRetry,
		GetLoginLockTime:      Captcha.GetLoginLockTime,
		ClearLoginRetry:       Captcha.ClearLoginRetry,
		CreateLoginLog:        Log.CreateLoginLog,
		GenerateToken:         utils.GenerateToken,
		GetUserInfoFromCache:  Cache.GetUserInfoFromCache,
		GetUserInfo:           User.GetUserInfo,
		GetUserMenus:          Menu.GetUserMenus,
		GetUserPermissions:    Menu.GetUserPermissions,
		SetUserInfoToCache:    Cache.SetUserInfoToCache,
		RedisGet: func(ctx context.Context, key string) (string, error) {
...
func (s *AuthFlowService) GetCurrentUserInfo(userID uint) (*UserInfoCache, *AuthFlowError) {
